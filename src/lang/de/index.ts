...
const de: KeywordRegistry = [
  ...
  { canonical: "deep learning", aliases: ["tiefes lernen"], category: "technical" },
  { canonical: "natural language processing", aliases: ["computerlinguistik", "sprachverarbeitung"], category: "technical" },
  { canonical: "computer vision", aliases: ["bildverarbeitung", "maschinelles sehen"], category: "technical" },
  { canonical: "web development", aliases: ["webentwicklung"], category: "technical" },
  { canonical: "full stack development", aliases: ["full-stack-entwicklung"], category: "technical" },
  { canonical: "data engineering", aliases: ["datenengineering", "dateningenieurwesen"], category: "technical" },
  { canonical: "embedded systems", aliases: ["eingebettete systeme"], category: "technical" },
  { canonical: "linux", aliases: [], category: "technical" },
  { canonical: "bash scripting", aliases: ["shell-skripting"], category: "technical" },
  // tools
  ...
  { canonical: "google cloud platform", aliases: ["google cloud"], category: "tool" },
  ...
  { canonical: "unit testing", aliases: ["unittests", "modultests"], category: "concept" },
  { canonical: "security", aliases: ["sicherheit"], category: "concept" },
  { canonical: "application security", aliases: ["anwendungssicherheit"], category: "concept" },
  ...
  { canonical: "ci/cd", aliases: ["kontinuierliche integration", "kontinuierliche bereitstellung"], category: "concept" },
  { canonical: "cloud computing", aliases: ["cloud-computing"], category: "concept" },
  { canonical: "system design", aliases: ["systemdesign"], category: "concept" },
  { canonical: "code review", aliases: ["codeüberprüfung", "codeueberpruefung"], category: "concept" },
  { canonical: "ux design", aliases: ["nutzererfahrung"], category: "concept" },
  { canonical: "ui design", aliases: ["benutzeroberflächendesign", "benutzeroberflaechendesign"], category: "concept" },
  { canonical: "project management", aliases: ["projektmanagement"], category: "concept" },
  { canonical: "program management", aliases: ["programmmanagement"], category: "concept" },
  { canonical: "change management", aliases: ["veränderungsmanagement", "veraenderungsmanagement"], category: "concept" },
  { canonical: "risk management", aliases: ["risikomanagement"], category: "concept" },
  { canonical: "quality assurance", aliases: ["qualitätssicherung", "qualitaetssicherung"], category: "concept" },
  { canonical: "documentation", aliases: ["dokumentation"], category: "concept" },
  { canonical: "requirements gathering", aliases: ["anforderungsanalyse"], category: "concept" },
  // domain — product / data
  { canonical: "analytics", aliases: ["datenanalyse"], category: "domain" },
  { canonical: "roadmap", aliases: ["fahrplan"], category: "domain" },
  { canonical: "product management", aliases: ["produktmanagement"], category: "domain" },
  { canonical: "product strategy", aliases: ["produktstrategie"], category: "domain" },
  { canonical: "stakeholder management", aliases: ["stakeholder-management"], category: "domain" },
  // domain — finance / accounting
  { canonical: "financial analysis", aliases: ["finanzanalyse"], category: "domain" },
  { canonical: "financial modeling", aliases: ["finanzmodellierung"], category: "domain" },
  ...
  { canonical: "auditing", aliases: ["wirtschaftsprüfung", "wirtschaftspruefung"], category: "domain" },
  { canonical: "general ledger", aliases: ["hauptbuch"], category: "domain" },
  { canonical: "mergers and acquisitions", aliases: ["fusionen und übernahmen", "fusionen und uebernahmen"], category: "domain" },
  ...
  { canonical: "business development", aliases: ["geschäftsentwicklung", "geschaeftsentwicklung"], category: "domain" },
  { canonical: "lead generation", aliases: ["leadgenerierung"], category: "domain" },
  { canonical: "saas", aliases: ["software als dienstleistung"], category: "domain" },
  { canonical: "e-commerce", aliases: ["elektronischer handel"], category: "domain" },
  ...
  { canonical: "performance management", aliases: ["leistungsmanagement"], category: "domain" },
  { canonical: "diversity and inclusion", aliases: ["vielfalt und inklusion"], category: "domain" },
  { canonical: "employee engagement", aliases: ["mitarbeiterengagement"], category: "domain" },
  // domain — healthcare
  { canonical: "patient care", aliases: ["patientenversorgung"], category: "domain" },
  { canonical: "clinical documentation", aliases: ["klinische dokumentation"], category: "domain" },
  { canonical: "clinical trials", aliases: ["klinische studien"], category: "domain" },
  // domain — legal
  ...
  { canonical: "due diligence", aliases: ["sorgfaltspflicht"], category: "domain" },
  { canonical: "gdpr", aliases: ["dsgvo"], category: "domain" },
  { canonical: "intellectual property", aliases: ["geistiges eigentum"], category: "domain" },
  // domain — education
  { canonical: "curriculum development", aliases: ["lehrplanentwicklung"], category: "domain" },
  { canonical: "lesson planning", aliases: ["unterrichtsplanung"], category: "domain" },
  ...
  { canonical: "quality control", aliases: ["qualitätskontrolle", "qualitaetskontrolle"], category: "domain" },
  // domain — customer service
  { canonical: "customer support", aliases: ["kundensupport", "kundendienst"], category: "domain" },
  { canonical: "customer success", aliases: ["kundenerfolg"], category: "domain" },
  // soft skills
  ...
  { canonical: "organization", aliases: ["organisationsfähigkeit", "organisationsfaehigkeit"], category: "soft" },
  { canonical: "public speaking", aliases: ["öffentliches sprechen", "oeffentliches sprechen"], category: "soft" },
  { canonical: "strategic thinking", aliases: ["strategisches denken"], category: "soft" },
  { canonical: "empathy", aliases: ["empathie"], category: "soft" },
  // marketing
  { canonical: "seo", aliases: ["suchmaschinenoptimierung"], category: "marketing" },
  { canonical: "branding", aliases: ["markenbildung"], category: "marketing" },
  { canonical: "campaign management", aliases: ["kampagnenmanagement"], category: "marketing" },
  ...
  { canonical: "social media marketing", aliases: ["social-media-marketing"], category: "marketing" },
  { canonical: "email marketing", aliases: ["e-mail-marketing"], category: "marketing" },
  { canonical: "market research", aliases: ["marktforschung"], category: "marketing" },
  { canonical: "marketing automation", aliases: ["marketing-automatisierung"], category: "marketing" },
  { canonical: "brand awareness", aliases: ["markenbekanntheit"], category: "marketing" },
];
